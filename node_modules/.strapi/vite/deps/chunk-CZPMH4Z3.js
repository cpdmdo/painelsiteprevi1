import {
  ...
  QueryClientProvider,
  img
} from "./chunk-FW6YDHTI.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-FUXBAFSB.js";
import {
  useNpsSurveySettings
} from "./chunk-WKRLBAHL.js";
import {
  GuidedTourContext
} from "./chunk-FLTPYCLM.js";
import {
  require_pick
} from "./chunk-PSHXITO4.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-MTJ2T5LZ.js";
import {
  useEnterprise
} from "./chunk-IMOI3E47.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-YFX4REIS.js";
import {
  Login
} from "./chunk-W4DC4TFI.js";
import {
  MemoizedInputRenderer
} from "./chunk-ELTJVSGP.js";
import {
  Form
} from "./chunk-JBXQL3NF.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-6GWDPKB3.js";
import {
  ConfigurationProvider
} from "./chunk-EMIP5S33.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-BYI2GZFR.js";
import {
  require_baseRest
} from "./chunk-5RDCNDRC.js";
import {
  HistoryProvider
} from "./chunk-CJYWQ3XL.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-M52JAITN.js";
import {
  Layouts
} from "./chunk-QDH6BVEL.js";
import {
  TrackingProvider,
  useTracking
...
} from "./chunk-KVOXAC2C.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-3XFDDFRS.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-7YJFUHDK.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
...
var { useGetKeyStatisticsQuery, useGetCountDocumentsQuery } = homepageService;
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-X2OX2ERF.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-QDEBNINC.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-LC2P7OC4.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-PMTDSWLN.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-J52TTJO4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-MQPUOYFV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-USF5NFIE.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QCTTFLWH.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-WEEMI6HY.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-JTA6J2DZ.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-HRJ6QUEV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-LNGOB2PF.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-VVGD3BDH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-MXTWPOJE.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-JDFCJEXK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-P5UNRLBF.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-7JLKDX6U.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-5WPTRPW2.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-ACECX5TZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-CAKZGL7D.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-53C7E62L.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-5DY5E3U3.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-HGJPILGD.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LHB6O5VA.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-UYTMF7RP.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-WFZ3GOPQ.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-OTW5VQV6.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-Z6BYYCHC.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-COFADJTC.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-TUIUKFAQ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-TUIUKFAQ.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-XRXBCJDJ.js");
...
//# sourceMappingURL=chunk-CZPMH4Z3.js.map

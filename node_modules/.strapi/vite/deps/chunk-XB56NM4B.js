...
import {
  LimitsModal
} from "./chunk-PSCWWHXH.js";
import {
  useTypedSelector
} from "./chunk-CEZQOIQ3.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-WLELKTSF.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-CACDOU6Z.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-YGYS4UJG.js";
import {
  useConfig
} from "./chunk-2AGLJWOQ.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-QRALR4RD.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-37RGHUA5.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-RFHZOUS3.js";
import {
  renderAdmin
} from "./chunk-CZPMH4Z3.js";
import {
  useLicenseLimits
} from "./chunk-UQERNFSE.js";
import {
  Table,
  useTable
} from "./chunk-VOMDN2HB.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-3YHACNAD.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-CHMWQE6F.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-Q6IQUIEG.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-CRF5R6NV.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-CH37MM2E.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-7EVWVARL.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-JA5O2PYM.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-ZC2ISLFB.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-EW4SRRMK.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-VTBRJD5S.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-QDQDMXMA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-TON6I2ZF.js");
          return {
...
//# sourceMappingURL=chunk-XB56NM4B.js.map
